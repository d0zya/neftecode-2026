...
Решение задачи хакатона [Neftecode 2026](https://neftecode.ru). Задача — предсказать два физико-химических параметра моторного масла по результатам теста Daimler Oxidation Test (DOT): на основе состава смеси, свойств компонентов и условий испытания.
